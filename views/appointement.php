...
<body style="background-image:url(img/52.jpg); background-size: cover;">
  <!-- ///////// navbar//////////// -->
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand mx-3" href="<?php echo BASE_URL; ?>logout" style="font-family: 'rubik', sans-serif;"><span style="color: #71a7ed;">H</span>ealth<span style="color:#71a7ed;">C</span>are</a>
