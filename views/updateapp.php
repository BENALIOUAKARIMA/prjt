...
if (isset($_POST['id'])) { //pour add et update
    ...
    $exitMalade = new AppointementController(); //exit ya3ni wach kayn ola la
    // cree objt mn class maladecontroller 
    $malade = $exitMalade->getOneAppointement(); // recuperer les malades
}else {
    Redirect::to('tableappointement'); 
}
if (isset($_POST['submit'])) {
    $exitMalade = new AppointementController();
    $malade =$exitMalade->updateMalade(); 
}
?>

<h1 class="text-center my-3"><span style="color:#0c96f1">'</span>Update Appointment
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-body bg-light">
                    <a href="<?php echo BASE_URL; ?>tableappointement" class="btn btn-sm btn-secondary mr-2 mb-2">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="service" id="" class="form-control" placeholder="Service" value="<?php echo $malade->service; ?>">
                        </div>
                        <div class="form-group">
