...
if (isset($_POST['id'])) { //pour add et update
    ...
    $exitMalade = new PaymentController(); //exit ya3ni wach kayn ola la
    // cree objt mn class maladecontroller 
    $malade = $exitMalade->getOnePay(); // recuperer les malades
}else {
    Redirect::to('payment'); 
}
if (isset($_POST['submit'])) {
    $exitMalade = new PaymentController();
    $malade =$exitMalade->updatePay(); 
}
?>
                ...
                <div class="card-body bg-light">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="montant" id="" class="form-control" placeholder="montant" value="<?php echo $malade->montant; ?>">
                        </div>
                        <div class="form-group">
