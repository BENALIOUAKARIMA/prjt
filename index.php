...
$pages = ['index', 'register', 'login', 'poste', 'payment', 'home', 'add', 'addpay', 'appointement', 'tableappointement', 'updatepay', 'updateapp', 'update', 'delete', 'deletepay', 'profile', 'tablecontact', 'contact', 'dashbord', 'logout'];
